...
function ProjectCard({ id, year, title, titleJP, description, tags, image }) {
  return (
    <Link
      to={`/project/${id}`}
      className="block flex flex-col h-full group shadow-sm border border-[#1A120B]/5"
    >
      <div className="group flex flex-col h-full cursor-pointer ">
        ...
        <div className="bg-font text-background px-6 py-6 flex flex-col flex-grow justify-between ">
          <div className="flex items-start justify-between">
            <div>
              ...
              <p className="text-xs text-background/50 leading-relaxed mt-4 line-clamp-3">
                {description}
              </p>
            </div>
