...
export const websiteProjects = [
  {
    ...
    titleJP: "カフェショップサイト",
    desc: "家族みんなが安心して過ごせるカフェをテーマに、Webサイトを制作しました。「家族の時間をやさしくつなぐ空間」をコンセプトに、温かみのある色合いや柔らかなレイアウトを取り入れ、訪れる前から安心感を感じられるようなデザインを意識しています。",
    ...
    client: "千葉県銚子市の水族館 銚子アクアワールド様（架空クライアント）",
  ...
  },
  {
    ...
    year: "2026",
    title: "Portfolio.",
    name: "MINI PORTFOLIO", // 👈 FIX 1: Bổ sung name cho portfolio khum bị trống
    titleJP: "ポートフォリオ",
  ...
  },
  {
    ...
    year: "2025",
    title: "Sneaker LP",
    name: "SNEAKER RUNNER", // 👈 FIX 1: Bổ sung name cho sneaker
    titleJP: "スニーカーLP",
    ...
    URL: "https://sneakerlp.example.com",
  },
  {
    id: "okayama-kankou",
    year: "2025",
    title: "Okayama kankou",
    name: "MOMOTARO LEGEND", // 👈 FIX 1: Bổ sung name cho okayama
    titleJP: "観光サイト",
...
export const appProjects = [
  {
    ...
    year: "2025",
    title: "EASY COOK APP",
    name: "EASY COOK", // 👈 FIX 1: Bổ sung name cho easy cook
    titleJP: "お弁当を提案するアプリ",
  ...
  },
  {
    ...
    year: "2025-2026",
    title: "Nemura APP",
    name: "NEMURA AI NEWS", // 👈 FIX 1: Bổ sung name cho nemura
...
// skillsData.js (Giữ nguyên phần skill ở dưới của bà)
export const skillData = [
  {
    ...
    skills: [
      {
        name: "Figma",
        desc: "Figmaを活用したUI/UXデザイン制作に取り組んでいます。エンジニアへのスムーズな引き継ぎを意識し、コンポーネント化やVariablesを用いた設計を実践しています。",
      },
      {
        name: "UI/UX",
        desc: "ユーザー視点に立ち、情報設計（IA）やユーザビリティを意識した、直感的で使いやすいUI/UXデザインを制作しています。",
      },
    ],
  },
  {
    ...
    skills: [
      {
        ...
        desc: "レスポンシブ対応やデザインを正確に再現するコンポーネント指向のUI実装に取り組んでいます。",
      },
      {
        name: "JavaScript/React",
        desc: "ViteやReact環境でのコンポーネントベース開発、状態管理、動的なUI表現を学び、実務を意識したフロントエンド実装への理解を深めています。",
      },
    ],
  },
];
