...
import portfoliomockupIntro from "../assets/portfoliomockupIntro.png";
// import portfoliomockupPC from "../assets/portfoliomockupPC.png";
// import portfoliomockupMobile from "../assets/portfoliomockupMobile.jpg";
...
export const websiteProjects = [
  {
    ...
    designConcept:
      "採用担当者に作品だけでなく、「どのような考え方でデザインしている人なのか」も伝わるポートフォリオを目指しました。\n私は、情報を整理し、ユーザーが迷わず理解できる体験を大切にしています。その考え方が伝わるよう、関連する情報をグループ化しながら構成を整理し、作品を「Webサイト」と「アプリ」に分類することで、興味のある作品へスムーズにたどり着けるよう設計しました。\nまた、作品そのものが主役になるようシンプルなレイアウトをベースとしながら、大胆なタイポグラフィやアクセントカラーを取り入れで、活動的な一面、自分の人柄が伝わるよう工夫しました。",
    problem:
  ...
  },
  {
    ...
    proposal:
      "家族の時間をやさしくつなぐ空間をコンセプトに、温かみのある茶色や柔らかなレイアウトを取り入れ、訪れる前から安心感を感じられるようなデザインを意識しました。",
    target: "子供連れの20代〜40代のファミリー層",
    objective:
      "家族連れを中心としたユーザーに店舗の魅力や安心感を伝え、\n来店前から親しみを感じてもらうことで、\n実際の来店につなげることを目的としました",
    designConcept:
      "サイト全体のコンセプトは、「安心感から生まれる笑顔」です。家族連れのお客様に、来店前からお店の温かな雰囲気や安心感を感じてもらえるようなサイトを目指しました。\nそのため、温かみのある茶色を基調とした配色や丸みのあるデザインを取り入れ、親しみやすい雰囲気を表現しています。また、スタッフやお客様の自然な表情が伝わる写真を使用することで、お店で過ごす時間を具体的にイメージできるよう工夫しました。",
    problem:
      "家族向けの店舗サイトを制作する中で、来店したことのないユーザーに「ここなら安心して過ごせそう」と感じてもらうために、店舗の雰囲気をどのように伝えるかが課題でした。",
    Learnings:
      "制作を通して、写真の見せ方によってサイト全体の印象が大きく変わることを学びました。特に今回は、店舗の雰囲気や人の表情が伝わる写真を選ぶことで、コンセプトである「笑顔」や「安心感」をより効果的に表現できました。",
    scope: "ディレクション / デザイン / コーディング",
    period: "企画：３週間\nデザイン：４週間\nコーディング：5週間",
  ...
  },
  {
    ...
    designConcept:
      "桃太郎伝説をきっかけに、岡山の歴史や文化、観光地の魅力を自然に知ってもらうことを目指しました。\nそのため、観光情報を一度に詰め込むのではなく、段階的に情報を見せることで、物語を読み進めるように岡山を巡れる構成にしています。また、自然をイメージしたグリーンを基調とすることで、親しみやすく落ち着いた世界観を表現しました。",
    problem:
...

  {
    ...
    designConcept:
      "新作スニーカーの持つカッコよさや熱量を感じてもらい、ブランドの世界観に引き込まれるような体験を目指しました。\nそのため、サイト全体を赤色で統一する大胆なデザインに挑戦しました。また、派手な赤色の中でも商品のスニーカーや重要な情報が埋もれないよう、黒と白を使ってメリハリをつけています。さらに、商品の情報や購入ボタンが自然と目に入る構成にすることで、世界観を楽しみながらスムーズに購入へ進めるよう工夫しました。",
    problem: "ブランドの世界観と商品の魅力を両立して伝えることが課題でした。",
    Learnings:
      "今回の制作を通して、見た目のインパクトだけでなく、「何を一番伝えたいのか」を明確にすることの大切さを学びました。ブランドの世界観を表現するだけでなく、ユーザーに見てほしい情報の優先順位を整理し、自然に視線を誘導することがデザインにおいて重要だと気づきました。",
    scope: "デザイン / コーディング",
    period: "1週間",
...
export const appProjects = [
  {
    ...
    member: [
      "アウン コ テッ(バックエンド、フロントエンド)",
      "久下 楓珠 (UX/UIデザイナー)",
      "菅野 友香 (フロントエンド)",
      "グエン ティ ハ ミー (UX/UIデザイナー)",
      "竹内 実乃莉 （グラフィクデザイナー）",
    ],
    ...
    scope: "ディレクション / デザイン（初回起動画面以外は担当しますた）",
    period: "約3ヶ月（チーム制作）",
    tools: "Figma / Illustrator ",
    URL: "https://nemura.vercel.app/welcome",
  },
  {
    id: "easy-cook",
    year: "2025",
    ...
    Learnings:
      "今回の制作を通して、子ども向けのデザインでは「分かりやすいこと」と同じくらい「楽しいこと」が大切だと学びました。どれだけ使いやすくても、子どもが楽しめなければ継続して使ってもらえないため、続けたくなる体験を設計することの大切さを実感しました。",
    scope: "ディレクション / デザイン",
    period: "約2.5ヶ月（チーム制作）",
    tools: "Figma",
    URL: "https://github.com/namdang0219/easy-cook",
  },
];
    ...
    skills: [
      {
        ...
        desc: `Figmaデザインの再現するコーディングやTailwind CSSを用いたレスポンシブ実装を中心にWebサイト制作に取り組んでいます。`,
      },
      {
        name: "JavaScript/React",
        desc: `Figmaでのコンポーネント制作や動的なUI表現に活かしています。`,
      },
    ],
  },
];
