...
export const appProjects = [
  {
    ...
    designConcept:
      "親子が一緒に料理を進められるよう、文字だけでなくアイコンも活用し、子どもでも直感的に理解できるデザインを意識しています。また、手順を「1画面1アクション」で構成することで、次に何をすればよいか迷わず進められるUIを設計しました。さらに、キャラクターの収集や完成したお弁当の記録機能を取り入れ、親子で楽しみながら継続して利用できる体験を目指しました。",
