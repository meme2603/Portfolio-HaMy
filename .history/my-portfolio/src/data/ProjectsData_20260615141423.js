...
export const websiteProjects = [
  ...
  },
  {
    ...
    designConcept:
      "就職活動用のポートフォリオサイトとして、シンプルでありながら自分らしさが伝わるデザインを目指しました。余白を活かしたレイアウトと大胆なタイポグラフィを取り入れ、作品が引き立つ構成にしています。また、また、黒をベースにすることで全体をすっきりとまとめ、アクセントとして赤を取り入れることで視線が集まるポイントを作りました。",
