...
export const websiteProjects = [
  ...
  },
  {
    ...
    objective:
      "桃太郎伝説と現在の岡山を結び付け、地域の歴史や文化に興味を持ってもらうことを目的としました。",
    designConcept:
    ...
    Learnings: "今回の制作を通して、デザインは見た目を整えるだけではなく、その背景にある文化や価値観を理解することが大切だと学びました。また、文化を理解するだけでなく、それを色使いや情報設計、ストーリー性のある体験としてどのように表現するかがデザイナーの役割であると実感しました。",
    scope: "ディレクション / デザイン ",
    period: "企画・WF：3日\nデザイン：5日",
