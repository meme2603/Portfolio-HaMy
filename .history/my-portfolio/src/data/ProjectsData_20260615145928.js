...
export const websiteProjects = [
  ...
  },
  {
    ...
    problem: "ポートフォリオ制作において、「限られた時間で採用担当者の印象に残ること」と「自分らしいデザイナーとしての個性を表現すること」の両立に難しさを感じました。",
    Learnings: "ポートフォリオ制作を通して、「見る人の気持ちになって、いかにストレスなく読んでもらうか」の大切さを学びました。忙しい採用担当者の方の視点に立ち、文字ばかりで読ませるのではなく、写真やモックアップを組み合わせて直感的に伝わるように工夫しました。",
    scope: "ディレクション / デザイン / コーディング",
    period: "デザイン：5週間\nコンディング：５週間\n企画・WF：4週間",
