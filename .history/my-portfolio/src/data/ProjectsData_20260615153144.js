...
export const websiteProjects = [
  ...
  },
  {
    ...
    designConcept:
      "新作スニーカーの持つカッコよさや熱量に伝えるために全体を「赤色」にするという大胆なデザインに挑戦しました。派手な赤色の中でも、商品のスニーカーや文字がちゃんと目立つように、「黒と白」をうまく使ってメリハリをつけています。ブランドの世界観に一瞬で引き込みつつも、商品の情報や購入ボタンがパッと目に入り,お買い物をスムーズに楽しめるような意識しました。",
    problem:
