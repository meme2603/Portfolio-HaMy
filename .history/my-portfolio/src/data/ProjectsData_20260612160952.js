...
export const websiteProjects = [
  {
    ...
    titleJP: "カフェショップサイト",
    proposal:
      "「家族の時間をやさしくつなぐ空間」をコンセプトに、温かみのある色合いや柔らかなレイアウトを取り入れ、訪れる前から安心感を感じられるようなデザインを意識しています。",
  ...
  },
  {
    ...
    titleJP: "ポートフォリオ",
    proposal:
      "就職活動用のポートフォリオサイトとして、シンプルで見やすいデザインを心がけました。作品の魅力を引き立てるために、余白を活かしたレイアウトと、落ち着いた色合いを選択しています。",
