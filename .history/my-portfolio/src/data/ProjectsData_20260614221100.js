...
export const websiteProjects = [
  {
    ...
    proposal:
      "家族の時間をやさしくつなぐ空間をコンセプトに、温かみのある色合いや柔らかなレイアウトを取り入れ、訪れる前から安心感を感じられるようなデザインを意識しています。",
    target: "子供連れの20代〜40代のファミリー層",
    objective:
      "家族連れを中心としたユーザーに店舗の魅力や安心感を伝え、\n来店前から親しみを感じてもらうことで、\n実際の来店につなげることを目的としました",
    designConcept:
      "サイト全体のコンセプトは、「安心感から生まれる笑顔」です。家族で過ごす時間の中で生まれる自然な笑顔や温かなコミュニケーションを大切にしたいと考えました。そのため、ユーザーがサイトを訪れた瞬間から安心感や親しみやすさを感じられるデザインを目指しています。温かみのあるベージュとブラウンを基調とし、柔らかな余白や丸みのあるデザインを取り入れることで、居心地の良い雰囲気を表現しました。また、スタッフやお客様の自然な表情が伝わる写真を活用し、店舗全体の温かな空気感が感じられるよう工夫しています。",
    problem: "既存のカフェサイトはスタイリッシュすぎて",
    Learnings: "ユーザーが最も知りたい『メニュー』",
