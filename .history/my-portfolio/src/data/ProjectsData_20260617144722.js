...
export const websiteProjects = [
  ...
  },
  {
    ...
    designConcept:
      "就職活動用のポートフォリオサイトとして、シンプルでありながら自分らしさが伝わるデザインを目指しました。余白を活かしたレイアウトと大胆なタイポグラフィを取り入れ、作品が引き立つ構成にしています。全体をすっきりとまとめる黒をベースに、視線を集めるアクセントとして赤を取り入れました。さらに、作品を「Webサイト」と「アプリ」に分類することで、閲覧者が興味のある分野の作品をスムーズに探せるよう設計しています。",
    problem:
    ...
    URL: "https://github.com/meme2603/Portfolio-HaMy",
  },
  {
    id: "sneaker-lp",
    year: "2025",
