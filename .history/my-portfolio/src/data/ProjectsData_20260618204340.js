...
export const websiteProjects = [
  ...
  },
  {
    ...
    designConcept:
      "サイト全体のコンセプトは、「安心感から生まれる笑顔」です。家族で過ごす時間の中で生まれる自然な笑顔や温かなコミュニケーションを大切にしたいと考え、ユーザーがサイトを訪れた瞬間から安心感や親しみやすさを感じられるデザインを目指しています。温かみのある茶色を基調とし、柔らかな余白や丸みのあるデザインを取り入れることで、居心地の良い雰囲気を表現しました。また、スタッフやお客様の自然な表情が伝わる写真を活用し、店舗全体の温かな空気感が感じられるよう工夫しています。",
    problem:
      "ターゲットである家族層に対して、店舗の温かい雰囲気や安心感をどのように伝えるかが課題でした。また、来店前にメニューや店舗情報を確認したいユーザーが、必要な情報へ迷わずアクセスできる設計が求められました。そこで、店舗の雰囲気が伝わる写真を大きく配置するとともに、温かみのある茶色を基調とした配色を採用し、安心感や親しみやすさを表現しました。さらに、メニューや店舗情報、アクセスへの導線を直感的に整理することで、ユーザーがストレスなくスムーズに情報を探せるよう工夫しました。",
    Learnings:
