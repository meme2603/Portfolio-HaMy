...
function Hero() {
  return (
    <section className="relative w-full h-[calc(100vh-88px)] mt-24 bg-background overflow-hidden flex flex-col items-center">
      ...
      <div className="relative w-full max-w-[1440px] flex justify-between items-center px-20 z-30 h-[500px]">
        <div className="w-[300px] flex flex-col items-center text-center space-y-2">
          <p className="text-lg font-poppins italic">Hi!</p>
          <div className="text-lg font-poppins leading-tight">
            My name is <br />
            <span className="font-semibold text-xl">NGUYEN THI HA MY</span>
          </div>
          <p className="text-xl font-light font-poppins">I'm from Vietnam</p>
        </div>
        ...
        <div className="w-[300px] flex flex-col items-center text-center space-y-2">
          <div className="text-xl font-light font-poppins leading-tight">
