          ...
          {allSkills.map((skill, index) => (
            ...
            >
              <div className="flex mb-4">
                <span className=" text-font font-akshar font-semibold uppercase tracking-wider text-xs md:text-sm lg:text-base rounded-md px-2 py-1 inline-block group-hover:bg-font group-hover:text-background transition-colors duration-300">
                  {skill.name}
                </span>
              </div>
