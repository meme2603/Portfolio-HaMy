...
function Hero() {
  return (
    <section className="relative w-full h-[calc(100vh-88px)] mt-24 bg-background overflow-hidden flex flex-col items-center pb-16">
      ...
      <div className="absolute h-13 bottom-0 left-0 w-full bg-font py-3 md:py-4 z-10">
        <p className="text-background text-center text-xs md:text-sm font-light tracking-[2px] z-50">
