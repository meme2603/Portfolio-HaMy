...
function Hero() {
  return (
    <section className="relative w-full h-[calc(100vh-96px)] mt-24 bg-background overflow-hidden flex flex-col items-center">
      ...
      <div className="relative w-full max-w-[1440px] grid grid-cols-3 items-baseline-last px-10 -mt-10 z-30">
        ...
        <div className="relative flex justify-center">
          <img
            src={avatarImg}
            alt="Ha My"
            className="absolute min-h-[400px] object-cover left-1/2 -translate-x-1/2"
          />
        </div>
