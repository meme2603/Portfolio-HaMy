  ...
  return (
    <section className="relative w-full h-[calc(100vh-96px)] mt-24 bg-background overflow-hidden flex flex-col items-center">
      ...
      <div className="w-full pt-10 z-20">
        <h1 className="text-[280px] font-bold font-logo text-center leading-[0.8] text-font">
          PORTFOLIO
        </h1>
      </div>
      ...
      <div className="relative w-full max-w-[1440px] grid grid-cols-3 items-center px-10 -mt-10 z-30">
        ...
        <div className="relative flex justify-center z-10">
          <img
            src="/your-photo.png" // Thay link ảnh của bà vào đây nha
            alt="Ha My"
      ...
      {/* 3. LỚP CHỮ DESIGNER (Nằm dưới cùng) */}
      <div className="relative w-full mt-auto z-0">
        <div className="relative flex justify-center pb-10">
          {/* Bóng đen */}
          <span className="absolute bottom-0 left-[50.3%] -translate-x-1/2 text-[18vw] font-bold font-logo leading-none tracking-tighter text-font">
            DESIGNER
          </span>
          {/* Chữ đỏ */}
          <h2 className="relative bottom-0 text-[18vw] font-bold font-logo leading-none tracking-tighter text-primary">
            DESIGNER
          </h2>
        </div>
      </div>
      ...
      {/* 4. FOOTER MESSAGE */}
      <div className="w-full bg-font py-4 z-40">
