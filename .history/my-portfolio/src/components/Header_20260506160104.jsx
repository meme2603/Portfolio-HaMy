  ...
  return (
    <header className="fixed top-0 left-0 w-full h-24 bg-background border-b border-gray-300 z-50">
      <div className="max-w-7xl mx-auto h-full px-6 flex justify-between items-center">
        ...
        <button
          id="menu-btn"
          class="block md:hidden text-[#9C0000] focus:outline-none z-50"
          aria-label="Menu"
        >
          <svg
        ...
        >
          <a href="#about" class="text-[#9C0000] text-[22px]">
            About
          </a>
          <a href="#projects" class="text-[#9C0000] text-[22px]">
            Projects
          </a>
          <a href="#contact" class="text-[#9C0000] text-[22px]">
            Contact
          </a>
        </div>
      </div>
