    ...
    <section className="relative w-full h-[calc(100vh-96px)] mt-24 bg-background overflow-hidden flex flex-col items-center">
      ...
      <div className="relative w-full mt-auto z-0">
        <div className="relative flex justify-center">
          <span className="absolute left-[50.3%] -translate-x-1/2 text-[18vw] font-bold font-akshar mb-4 tracking-tighter text-font">
            DESIGNER
          </span>

          <h2 className="relative  text-[18vw] font-bold font-akshar mb-4  tracking-tighter text-primary">
            DESIGNER
          </h2>
        </div>
      </div>
