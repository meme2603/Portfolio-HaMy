  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto pt-6">
        ...
        {/* 1. Bổ sung action link Formspree và method POST vào đây */}
        <form
          action="https://formspree.io/f/xnjzqegr"
          method="POST"
          className="max-w-3xl mx-auto px-6 md:px-0"
        >
          {/* Ô nhập tên: Thêm name="name" và required */}
          <input
            type="text"
            name="name"
            ...
            className="
                ...
                "
          />
          {/* Ô nhập Email: Thêm name="email" và required */}
          <input
            type="email"
            name="email"
            ...
            className="
                ...
                "
          />
          {/* Ô nhập nội dung: Thêm name="message" */}
          <textarea
            name="message"
          ...
          {/* Nút gửi: Đảm bảo có type="submit" để kích hoạt gửi form */}
        ...
        {/* Giữ nguyên các nút mạng xã hội của bà */}
