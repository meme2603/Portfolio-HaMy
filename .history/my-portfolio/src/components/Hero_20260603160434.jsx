...
function Hero() {
  return (
    ...
    <section className="relative w-full h-[calc(100vh-88px)] mt-24 bg-background overflow-hidden flex flex-col items-center justify-between pb-4">
      ...
      <div className="relative w-full max-w-[1440px] flex flex-col md:flex-row items-center md:items-end justify-center z-30 px-6">
        {/* LEFT */}
        ...
        <div className="relative flex justify-center shrink-0 z-30">
          <img
            src={avatarImg}
            alt="Ha My"
            className="
