      ...
      <div className="relative w-full max-w-[1440px] flex justify-between items-center px-10 z-30 min-h-[450px]">
        ...
        <div className="relative flex-1 flex justify-center items-center">
          <img
            src={avatarImg}
            alt="Ha My"
            {/* Bí kíp: Dùng absolute và top-1/2 -translate-y-1/2 để ảnh luôn nằm tâm của 2 khối text */}
        ...
        <div className="w-[350px] flex flex-col items-center text-center space-y-2">
          <p className="text-xl font-light leading-tight">
            I'm <span className="font-semibold text-xl">UI/UX Designer</span> <br /> and
          </p>
          <p className="text-xl font-semibold font-poppins uppercase tracking-wide">Basic Frontend</p>
          <p className="text-lg font-light font-poppins italic">Now I'm living in Japan.</p>
        </div>
      </div>
