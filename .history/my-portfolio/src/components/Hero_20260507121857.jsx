  ...
  return (
    <section className="relative w-full h-[calc(100vh-96px)] mt-24 bg-background overflow-hidden flex flex-col items-center">
      ...
      <div className="relative w-full mt-auto z-0">
        <div className="relative flex justify-center leading-none -mb-4">
          <span className="absolute left-[50.3%] -translate-x-1/2 text-[250px] font-bold font-akshar tracking-tighter text-font">
            DESIGNER
          </span>
