...
function Hero() {
  return (
    <section className="relative w-full min-w-[640px] h-[calc(100vh-88px)] mt-24 bg-background overflow-hidden flex flex-col items-center pb-16">
      ...
      <div className="relative w-full max-w-[1440px] flex items-end justify-center z-30 px-6 md:">
        <div
          className="
        flex-1 
        flex 
        ...
        <div className="relative hidden md:flex justify-center shrink-0">
          <img
            src={avatarImg}
            alt="Ha My"
            className="block h-[601px] object-cover"
          />
        </div>
        ...
        <div className="flex-1 flex justify-center pb-80">
          <div className="flex flex-col text-center space-y-2">
            ...
            >
              I'm
              <span className="font-semibold text-xllg:text-xl md:text-lg sm:text-base">
                UI/UX Designer
              </span>{" "}
              and
            </p>
      ...
      <div className="relative w-full -mt-40 z-40">
