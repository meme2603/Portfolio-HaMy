    ...
    <section className="relative w-full h-[calc(100vh-96px)] mt-24 bg-background overflow-hidden flex flex-col items-center">
      ...
      <div className="relative w-full mt-auto z-0 flex flex-col items-center">
        <div className="relative flex justify-center leading-none">
          ...
          <span className="absolute left-[50.3%] -translate-x-1/2 text-[18vw] font-bold font-akshar tracking-tighter text-font leading-none">
            DESIGNER
          </span>
          <h2 className="relative text-[18vw] font-bold font-akshar tracking-tighter text-primary leading-none">
            DESIGNER
          </h2>
        </div>
      </div>
