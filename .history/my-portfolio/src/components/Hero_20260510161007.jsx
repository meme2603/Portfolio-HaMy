...
function Hero() {
  return (
    <section className="relative w-full h-[calc(100vh-88px)] mt-24 bg-background overflow-hidden flex flex-col items-center ">
      ...
      {/* CENTER CONTENT */}
      <div className="relative w-full max-w-[1440px] flex items-end justify-center z-30">
        {/* LEFT */}
        ...
        <div className="relative flex justify-center shrink-0">
          <img
            src={avatarImg}
            alt="Ha My"
            className="block h-[620px] object-contain"
          />
        </div>

        {/* RIGHT */}
        <div className="flex-1 flex justify-center pb-50">
      ...
      {/* DESIGNER */}
      <div className="relative w-full -mt-36 z-40">
        <div className="relative flex justify-center leading-none -mb-12">
          <span className="absolute left-[50.3%] top-[1%] -translate-x-1/2 text-[200px] font-bold font-akshar tracking-tighter text-font">
            DESIGNER
          </span>

          <h2 className="relative text-[200px] font-bold font-akshar tracking-tighter text-primary">
            DESIGNER
          </h2>
        </div>
      </div>

      <div className="absolute bottom-0 left-0 w-full bg-font py-4 z-50">
