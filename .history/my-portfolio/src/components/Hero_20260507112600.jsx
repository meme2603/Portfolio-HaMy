function Hero() {
  return (
    <section className="relative w-full h-[calc(100vh-96px)] bg-background overflow-hidden flex flex-col items-center">
      {/* 1. LỚP CHỮ PORTFOLIO (Nằm trên cùng) */}
      <div className="w-full pt-10 z-20">
        <h1 className="text-[18vw] font-bold font-logo text-center leading-[0.8] text-primary">
          PORTFOLIO
        </h1>
      </div>
      ...
      <div className="relative w-full mt-auto z-0">
        <div className="relative flex justify-center pb-10">
          {/* Bóng đen */}
          <span className="absolute top-[4px] left-[50.3%] -translate-x-1/2 text-[18vw] font-bold font-logo leading-none tracking-tighter text-primary">
            DESIGNER
          </span>
          {/* Chữ đỏ */}
