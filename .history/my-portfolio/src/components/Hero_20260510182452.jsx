...
function Hero() {
  return (
    <section className="relative w-full h-[calc(100vh-88px)] mt-24 bg-background overflow-hidden flex flex-col items-center pb-16">
      ...
      <div className="<div className="relative w-full max-w-[1440px] flex flex-col md:flex-row items-center md:items-end justify-center z-30">">
        {/* LEFT */}
        <div className="flex-1 flex justify-center pb-24 md:pb-40 lg:pb-80">
      ...
      {/* DESIGNER */}
      <div className="relative w-full -mt-16 md:-mt-24 lg:-mt-40 z-40">
