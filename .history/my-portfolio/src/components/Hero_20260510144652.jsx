...
function Hero() {
  return (
    <section className="relative w-full h-[calc(100vh-96px)] mt-24 bg-background overflow-hidden flex flex-col items-center">
      <div className="w-full pt-10 pb-[17px] z-20">
        <h1 className="text-[210px] font-bold font-akshar text-center leading-[0.7] text-font tracking-tighter">
          PORTFOLIO
        </h1>
      </div>

      <div className="relative w-full max-w-[1440px] grid grid-cols-3 items-center px-10 -mt-10 z-30 h-[300px]">
        ...
        <div className="relative flex justify-center">
          <img
            src={avatarImg}
            alt="Ha My"
            className="absolute w-100% h-100% min-h-[400px] object-cover left-1/2 -translate-x-1/2"
          />
        </div>
