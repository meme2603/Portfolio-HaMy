      ...
      <header className="fixed top-0 left-0 w-full h-24 bg-background border-b border-gray-300 z-50">
        <div className="max-w-7xl mx-auto h-full px-6 flex justify-between items-center">
          <div className="shrink-0">
            <a
              href="/"
              className="text-4xl text-primary font-semibold font-logo"
            >
              HA MY
            </a>
          </div>
        ...
        <div
          ...
          `}
        >
          <a href="#about" onClick={() => setIsOpen(false)} className="text-color-primary text-2xl">About</a>
          <a href="#projects" onClick={() => setIsOpen(false)} className="text-color-primary text-2xl">Projects</a>
          <a href="#contact" onClick={() => setIsOpen(false)} className="text-color-primary text-2xl">Contact</a>
        </div>
        </div>
      </header>
    );
