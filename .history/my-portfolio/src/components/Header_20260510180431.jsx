...
function Header() {
  ...
  return (
    <header className="fixed top-0 left-0 w-full min-w-[640px] h-24 bg-background border-b border-gray-300 z-50">
      <div className="max-w-7xl mx-auto h-full px-6 flex justify-between items-center">
        ...
        <button
          ...
          className="block lg:hidden text-primary focus:outline-none z-50"
          aria-label="Menu"
        >
          <svg
        ...
        <div
          className={`
            ...
            flex flex-col items-center shadow-lg lg:hidden
