...
function Hero() {
  return (
    ...
    <section className="relative w-full h-[calc(100vh-88px)] mt-24 bg-background overflow-hidden flex flex-col items-center justify-between pb-4">
      ...
      <div className="w-full pt-5 pb-2 z-20 shrink-0">
        <h1
          className="
            text-[80px]
            md:text-[130px]
      ...
      <div className="relative w-full max-w-[1440px] flex flex-col md:flex-row items-center md:items-end justify-center z-30 px-4">
        {/* LEFT */}
