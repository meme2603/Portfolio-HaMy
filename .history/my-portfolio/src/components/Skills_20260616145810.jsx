          ...
          {allSkills.map((skill, index) => (
            ...
            >
              <div className="flex mb-4">
                <span className=" text-primary font-akshar font-semibold uppercase tracking-wider text-xs md:text-sm lg:text-base rounded-sm px-4 py-1.5 inline-block group-hover:bg-font group-hover:text-background transition-colors duration-300">
                  {skill.name}
                </span>
              </div>
