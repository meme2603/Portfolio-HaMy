  ...
  return (
    <section className="relative w-full h-[calc(100vh-96px)] mt-24 bg-background overflow-hidden flex flex-col items-center">
      <div className="w-full pt-8 z-20">
        <h1 className="text-[220px] font-bold font-akshar text-center leading-[0.7] text-font tracking-tighter">
          PORTFOLIO
        </h1>
      </div>
      ...
      <div className="relative w-full mt-auto z-40">
        <div className="relative flex justify-center leading-none -mb-12">
          <span className="absolute left-[50.3%] top-[1%] -translate-x-1/2 text-[220px] font-bold font-akshar tracking-tighter text-font">
            DESIGNER
          </span>

          <h2 className="relative  text-[220px] font-bold font-akshar  tracking-tighter text-primary">
            DESIGNER
          </h2>
        </div>
      </div>
