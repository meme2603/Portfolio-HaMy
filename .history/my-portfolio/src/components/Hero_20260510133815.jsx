  ...
  return (
    <section className="relative w-full h-[calc(100vh-96px)] mt-24 bg-background overflow-hidden flex flex-col items-center">
      <div className="w-full pt-10 z-20">
        <h1 className="text-[200px] font-bold font-akshar text-center leading-[0.7] text-font tracking-[8px]">
          PORTFOLIO
        </h1>
      </div>

      < className="relative w-full max-w-[1440px] grid grid-cols-3 items-center px-10 -mt-10 z-30">
