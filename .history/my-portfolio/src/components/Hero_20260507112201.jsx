function Hero() {
  return (
    <section className="relative w-full min-h-screen bg-background flex flex-col items-center">
      {/* 1. LỚP CHỮ PORTFOLIO (Nằm trên cùng) */}
      <div className="w-full pt-10 z-20">
        <h1 className="text-[18vw] font-bold font-logo text-center leading-[0.8] tracking-tighter text-primary">
          PORTFOLIO
        </h1>
      </div>
