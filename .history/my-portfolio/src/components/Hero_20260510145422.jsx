...
function Hero() {
  return (
    <section className="relative w-full h-[calc(100vh-96px)] mt-24 bg-background overflow-hidden flex flex-col items-center">
      ...
      <div className="relative w-full max-w-[1440px] grid grid-cols-3 items-center px-10 mt-[-40px] z-30">
        ...
        <div className="relative flex justify-center">
          <img
            src={avatarImg}
            alt="Ha My"
            className=" w-full h-full min-h-[400px] object-cover left-1/2 -translate-x-1/2"
          />
        </div>
