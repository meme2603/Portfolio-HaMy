    ...
    skills: [
      {
        name: "Figma",
        status: "Advanced",
        desc: "Auto Layout, Variables, Component System.",
      },
      {
        name: "UI/UX Design",
        status: "Intermediate",
      ...
      },
      {
        name: "Adobe Suite",
        status: "Basic",
        desc: "Photoshop, Illustrator cơ bản.",
      },
    ],
  },
  {
    ...
    skills: [
      // Tầng trên: Những cái đã Stable / Basic vững
      {
        name: "HTML / CSS / Tailwind",
        status: "Stable",
        desc: "Responsive design, UI implementation chuyên sâu.",
      },
      // Tầng dưới: Những cái đang Learning (Tự động xếp dưới vì nằm sau trong mảng)
      {
        name: "JavaScript & React",
        status: "Learning",
        desc: "Nắm vững ES6+, đang học State management và Component-based.",
      },
    ],
  },
];
