function Hero() {
  return (
    <section className="w-full mx-auto bg-background min-h-screen flex flex-col justify-between items-center text-center overflow-hidden">
      <h1 className="w-full pt-4 border-b border-gray-200">PORTFOLIO</h1>
