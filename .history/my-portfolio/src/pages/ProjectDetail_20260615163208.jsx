          ...
          <div className="w-full max-w-7xl mx-auto mb-20">
            <div className="grid grid-cols-1 md:grid-cols-12 gap-12 items-center">
              <div className="md:col-span-5 space-y-4">
                ...
                {project.URL ? (
                  // Thằng này hiện khi CÓ link dự án
                  <div className="pt-2">
                    <a
                      href={project.URL}
                      target="_blank"
                  ...
                  // Thằng này hiện khi KHUM CÓ link dự án (Đang trong quá trình code)
                  <div className="pt-2 flex items-center gap-2 select-none">
                    {/* Dùng màu nhạt text-font/40 và font-mono hoặc italic nhìn cho có vibe dev đang cày cuốc nha bà */}
                    <span className="w-2 h-2 rounded-full bg-amber-600 animate-pulse"></span>
                    <span className="text-lg font-medium text-font/40 tracking-wider italic font-sans">
                      コーディング中...
                    </span>
                  </div>
                )}
