                ...
                {project.URL ? (
                  <div className="pt-2">
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="text-2xl text-primary underline tracking-wide hover:text-[#3C2A21] transition-colors"
                    >
                      サイトを見る
                    </a>
                  </div>
                  ...
                  <div className="pt-2 flex items-center gap-2 select-none">
                    <span className="text-lg font-medium underline text-font/60 tracking-wider  font-sans">
                      コーディング中
                    </span>
                  </div>
                )}
          ...
          <div className="w-full max-w-7xl m-auto bg-font text-background md:py-16 mb-16 shadow-md">
            <div className="max-w-4xl mx-auto px-8 md:px-12">
              <div className="divide-y divide-white/10 border-t border-b border-white/10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-4 md:gap-8 py-6 items-start">
                  <div className="md:col-span-3 text-base md:text-lg font-bold tracking-wider text-white/90">
                    ターゲット
                  </div>
                  <div className="md:col-span-9 text-base md:text-lg text-white/80 leading-relaxed font-light">
                    {project.target || "未設定"}
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-4 md:gap-8 py-6 items-start">
                  ...
                  <div className="md:col-span-9 text-base md:text-lg text-white/80 leading-relaxed font-light whitespace-pre-line">
          ...
          <div className="w-full max-w-7xl mx-auto mb-20 px-8 md:px-0">
            <div className="grid grid-cols-1 md:grid-cols-12 gap-12 items-center">
                ...
                {project.URL && (
                  <div className="pt-2">
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="text-2xl text-background underline tracking-wide hover:text-primary"
                    >
                      サイトを見る
                    </a>
                  </div>
              ...
              <div className="md:col-span-6 bg-background/5 p-8 rounded-sm border border-background/5">
                <h3 className="text-sm md:text-base font-extrabold uppercase tracking-widest text-background mb-4 font-poppins pb-1.5 border-b border-background/20">
                  チームメンバー
                </h3>
                <div className="text-xs md:text-sm text-background/80 leading-relaxed font-light flex flex-col gap-2">
                  {project.member &&
                    Array.isArray(project.member) &&
                    project.member.map((name, index) => (
