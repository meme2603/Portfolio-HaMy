      ...
      <div className="w-full mx-auto">
        ...
        <div className="w-full pt-24 pb-4 px-20">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mb-24">
            {allProjects
              .filter((item) => item.id !== id) // 1. Lọc bỏ cái dự án đang xem ra rìa
              .slice(0, 3) // 2. Chỉ cắn đúng 3 cái còn lại để card to, rõ nét, khum bị bé
              .map((item) => (
                <Link
                  key={item.id}
                  to={`/project/${item.id}`}
                ...
                >
                  {/* Khung ảnh Thumbnail 4:3 siêu sạch và tối giản */}
