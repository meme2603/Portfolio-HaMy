        ...
        <div className="w-full mx-auto">
          ...
          <div className="w-full max-w-7xl mx-auto mb-20 px-6 md:px-0">
            <div className="space-y-4 max-w-3xl">
              ...
              <h1 className="text-3xl md:text-4xl font-bold tracking-tight uppercase text-font font-poppins">
                {project.title}
              </h1>
              <p className="text-xs md:text-sm leading-relaxed text-font/70 font-light pt-2 whitespace-pre-line">
                {project.proposal || project.desc}
              </p>
            </div>
          </div>
