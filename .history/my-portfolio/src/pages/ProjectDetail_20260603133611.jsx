...
function ProjectDetail() {
  ...
  return (
    <section className="w-full bg-[#FAF7F2] text-[#1A120B] pt-20 pb-24 font-sans antialiased">
      {/* Nút Back to home nhỏ gọn phía trên cùng */}
      ...
      {/* ─── BLOCK 1: HERO IMAGE (Ảnh to tràn viền trên cùng) ─── */}
      {project.mockupHero && (
