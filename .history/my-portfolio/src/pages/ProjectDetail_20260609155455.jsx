        ...
        <div className="w-full mx-auto">
          ...
          <div className="w-full max-w-7xl mx-auto mb-20 px-6 md:px-0">
            <div className="space-y-4 max-w-3xl">
              ...
              <p className="text-xs md:text-sm leading-relaxed text-[#1A120B]/70 font-light pt-2 whitespace-pre-line">
                {project.desc}
              </p>
            </div>
          </div>

          {/* 3. 🎯 SỬA TẠI ĐÂY: Chỉ hiện đúng ảnh Concept của Portfolio ở cuối, bỏ hoàn toàn PC/Mobile */}
          {project.mockupConcept && (
