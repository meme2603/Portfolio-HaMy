  ...
  return (
    ...
    <section className="w-full bg-background text-font py-10">
      <div className="w-full mx-auto">
        ...
        {/* Padding top lớn (pt-24) và thêm border mờ phía trên để tách biệt layout */}
        <div className="w-full border-t border-[#1A120B]/10 pt-24 pb-4">
          {/* Hàng tiêu đề chính và nút điều hướng < > */}
          <div className="flex justify-between items-center mb-12">
            {/* Chữ "他にも見る" bự, màu đỏ đô theo thiết kế */}
            <h3 className="text-[54px] md:text-[64px] font-bold text-[#990000] tracking-tight font-sans leading-none">
              他にも見る
            </h3>

            {/* Hai nút mũi tên điều hướng mảnh dẻ dạt sang phải */}
            <div className="flex gap-6 text-[#1A120B] text-2xl md:text-3xl font-light pr-2 select-none">
              <span className="cursor-pointer hover:text-amber-800 transition-colors duration-200">
                &lt;
              </span>
              <span className="cursor-pointer hover:text-amber-800 transition-colors duration-200">
                &gt;
          ...
          {/* Grid hiển thị 3 dự án liên quan (Sử dụng component ProjectCard của bà) */}
          ...
          <div className="w-full border-[#1A120B]/10 pt-6 flex flex-col sm:flex-row justify-between items-center gap-4 text-xs md:text-sm font-light text-[#1A120B]/80 tracking-wide">
