      ...
      <section className="w-full bg-background text-font py-10">
        <div className="w-full mx-auto">
          ...
          {(project.mockupPC || project.mockupMobile) && (
            <div className="w-full max-w-7xl mx-auto mb-24 px-6 md:px-0">
              <div className="grid grid-cols-12 gap-10 items-start">
                {/* 💻 MOCKUP PC CUỘN TRONG KHUNG */}
                <div className="col-span-12 md:col-span-7">
                  {project.mockupPC && (
                    <div className="flex flex-col gap-2">
                      {/* Chữ chỉ dẫn nhỏ cho user biết là cuộn được nha bà */}
                      <span className="text-xs font-mono opacity-50 text-font">
                        // Desktop View (Hover to scroll)
                      </span>

                      {/* Chiếc hộp thần kỳ cố định chiều cao 450px, ảnh dài cỡ nào cũng bị nhốt vào đây */}
                      <div className="w-full h-[450px] overflow-y-auto rounded-sm border border-font/10 shadow-md bg-white custom-scroll-container">
                        <img
                ...
                {/* 📱 MOCKUP MOBILE CUỘN TRONG KHUNG */}
                <div className="col-span-12 md:col-span-5">
                  {project.mockupMobile && (
                    <div className="flex flex-col gap-2">
                      <span className="text-xs font-mono opacity-50 text-font">
                        // Mobile View (Hover to scroll)
                      </span>

                      {/* Khung mobile tui bo góc tròn hơn xíu (rounded-xl) nhìn cho giống cái dáng điện thoại */}
                      <div className="w-full h-[450px] overflow-y-auto rounded-xl border border-font/10 shadow-md bg-white custom-scroll-container">
                        <img
