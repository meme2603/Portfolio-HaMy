  ...
  return (
    ...
    <section className="w-full bg-background text-font py-10">
      <div className="w-full mx-auto">
        ...
        {/* ─── BLOCK 5: FULL LAYOUT SHOWCASE (Bóp gọn gàng vào giữa dòng) ─── */}
        {(project.mockupPC || project.mockupMobile) && (
          <div className="w-full max-w-7xl mb-28 flex justify-center">
            {/* 👇 FIX CHÍ MẠNG: Ép hai ảnh thu nhỏ lại, nằm gọn trong khung max-w-4xl hoặc 5xl cực kỳ tinh tế */}
            <div className="w-full max-w-4xl md:max-w-5xl grid grid-cols-12 gap-8 items-start px-4">
              {/* Bản Web PC (Chiếm 7 cột) - Thu nhỏ theo khung */}
              ...
              {/* Bản Mobile dài thượt (Chiếm 5 cột) - Nhỏ nhắn, gọn gàng bên cạnh */}
