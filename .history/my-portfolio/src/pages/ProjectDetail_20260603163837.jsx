  ...
  return (
    ...
    <section className="w-full bg-background text-font my-16">
      <div className="max-w-7xl mx-auto">
        ...
        {/* ─── BLOCK 4: 企画・設計詳細 (Chuẩn đét theo ảnh Figma: Tối giản, đường kẻ ngang mờ) ─── */}
        <div className="w-full bg-[#000000] text-[#FAF7F2] py-16 md:py-20 mb-16 rounded-2xl shadow-md">
