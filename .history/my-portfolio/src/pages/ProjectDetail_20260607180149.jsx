...
function ProjectDetail() {
  ...
  if (!project) {
    return (
      <div className="text-center pt-24 text-[#1A120B]">
        プロジェクトが見つかりません。
      </div>
    );
  }
        ...
        <div className="w-full mx-auto">
          ...
          <div className="w-full max-w-7xl mx-auto mb-20">
            <div className="grid grid-cols-1 md:grid-cols-12 gap-12 items-center">
              <div className="md:col-span-5 space-y-4">
                <span className="text-xs font-medium tracking-wider text-font/60 block">
                  {project.titleJP}
                </span>
                <h1 className="text-3xl md:text-4xl font-bold tracking-tight uppercase text-font">
                  {project.title}
                </h1>
                <p className="text-xs md:text-sm leading-relaxed text-font/70 font-light pt-2 max-w-sm">
                  {project.desc}
                </p>
                {project.URL && (
                  <div className="pt-2">
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="text-xs text-primary underline tracking-wide hover:text-[#3C2A21]"
                    >
                      サイトを見る
                    </a>
                  </div>
          ...
          <div className="w-full max-w-7xl m-auto bg-font text-background md:py-16 mb-16 shadow-md">
            <div className="max-w-4xl mx-auto px-8 md:px-12">
              <div className="divide-y background/10 border-t border-b border-background/10">
                <div className="grid grid-cols-1 md:grid-cols-12 gap-4 md:gap-8 py-6 items-start">
                  <div className="md:col-span-3 text-xs md:text-sm font-bold tracking-wider text-background/90">
                    クライアント
                  </div>
                  <div className="md:col-span-9 text-xs md:text-sm text-background/80 leading-relaxed font-light">
                    {project.client ||
                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-4 md:gap-8 py-6 items-start">
                  ...
                  <div className="md:col-span-9 text-xs md:text-sm text-background/80 leading-relaxed font-light whitespace-pre-line">
          ...
          <div className="w-full max-w-7xl mx-auto mb-20 px-8 md:px-0">
            <div className="grid grid-cols-1 md:grid-cols-12 gap-12 items-center">
              <div className="md:col-span-6 space-y-4">
                ...
                <p className="text-xs md:text-sm leading-relaxed text-background/70 font-light pt-2 max-w-md">
                  {project.desc}
                </p>
              </div>
            ...
            <div className="max-w-4xl mx-auto px-8 md:px-12">
              <div className="divide-y background/10 border-t border-b border-background/10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-4 md:gap-8 py-6 items-start">
                  ...
                  <div className="md:col-span-9 text-xs md:text-sm text-background/90 leading-relaxed font-light">
                    {project.problem || "未設定"}
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-4 md:gap-8 py-6 items-start">
                  ...
                  <div className="md:col-span-9 text-xs md:text-sm text-background/90 leading-relaxed font-light whitespace-pre-line">
                    {project.period || "未設定"}
                  </div>
                </div>
    ...
    <div className="w-full min-h-screen">
      ...
      <div className="w-full pt-24 pb-4 px-20">
        <div className="flex justify-between items-center mb-12">
          <h3 className="text-[54px] md:text-[64px] lg:text-[80px] font-bold text-primary tracking-tight font-poppins leading-none">
            他にも見る
          </h3>

          <div className="flex gap-4 text-font pr-2 select-none">
            <button
              onClick={() => {
            ...
            <button
              onClick={() => {}}
              className="w-10 h-10 flex items-center justify-center rounded-full hover:bg-font/5 active:scale-95 transition-all duration-200"
            >
              <span className="material-symbols-outlined font-light">
                arrow_forward_ios
              </span>
        ...
        >
          {allProjects
            ...
            .map((item) => (
              ...
              >
                <div className="w-full aspect-[5/4] overflow-hidden bg-[#1A120B]/5 rounded-sm shadow-sm border border-[#1A120B]/5">
                  <img
                    src={item.img}
                    alt={item.title}
        ...
        <div className="w-full border-t border-[#1A120B]/10 pt-6 flex flex-col sm:flex-row justify-between items-center gap-4 text-xs md:text-sm font-light text-[#1A120B]/80 tracking-wide">
          ...
          <div className="font-sans text-font/70">
