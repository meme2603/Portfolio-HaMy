...
function ProjectDetail() {
  ...
  useEffect(() => {
    window.scrollTo({
      top: 0,
      behavior: "smooth", // Trượt lên mượt mà, nếu thích lên ngay lập tức thì đổi thành "auto" nha bà
    });
  }, [id]);
  ...
  return (
    <div className="w-full min-h-screen">
      ...
      return ( // 🎯 THẦN CHÚ 2: Thêm animate-fade-in hoặc hiệu ứng transition
      của Tailwind
      <div className="w-full min-h-screen bg-[#FAF7F2] text-[#1A120B] animate-fade-in duration-500 ease-in-out">
        {/* Khối hiển thị layout động */}
        {isWebsite ? renderWebsiteLayout() : renderAppLayout()}

        {/* BLOCK 6: "他にも見る" dùng chung */}
        <div className="w-full pt-24 pb-4 px-20">
          {/* ... code thanh trượt giữ nguyên ... */}
        </div>
      </div>
      );
    </div>
