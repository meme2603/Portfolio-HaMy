            ...
            {allProjects
              ...
              .map((item) => (
                <Link
                  key={item.id}
                  to={`/project/${item.id}`}
                  className="min-w-[290px] sm:min-w-[340px] md:min-w-[390px] flex-1 snap-start group block"
                >
                  {/* Gọi thẳng item.img (chính là cái coffeethumb bà đã import bên kia) */}
                  <div className="w-full aspect-[4/3] overflow-hidden bg-[#1A120B]/5 rounded-sm">
                    <img
                      src={item.img}
                      alt={item.title}
