...
function ProjectDetail() {
  ...
  return (
    ...
    <section className="w-full bg-background text-font my-16">
      <div className="w-full mx-auto">
        {/* ─── BLOCK 1: HERO IMAGE (Ảnh to tràn khung) ─── */}
        {project.mockupHero && (
          <div className="w-full max-w-7xl mx-auto mt-24 flex justify-center">
            <img
        ...
        <div className="w-full bg-font text-background md:py-16 mb-16 shadow-md">
        ...
        {/* ─── BLOCK 5: FULL LAYOUT SHOWCASE (PC & Mobile chạy dọc - Bỏ viền ngoài chuẩn Figma) ─── */}
        {(project.mockupPC || project.mockupMobile) && (
          <div className="w-full mb-24">
            <div className="grid grid-cols-12 gap-6 items-start">
              {/* Bản Web PC dài thượt (Chiếm 7 cột) - Không viền, không nền trắng */}
