            ...
            {allProjects
              ...
              .map((item) => (
                <Link
                  key={item.id}
                  to={`/project/${item.id}`}
                  className="min-w-[340px] sm:min-w-[390px] md:min-w-[460px] flex-1 snap-start group block"
                >
                  <div className="w-full gap-20 aspect-[5/4] overflow-hidden bg-[#1A120B]/5 rounded-sm shadow-sm border border-[#1A120B]/5">
                    <img
                      src={item.img}
                      alt={item.title}
